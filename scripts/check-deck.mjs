...
for (const requiredText of [
  ...
  "TRACKER SCOPE",
  "The documented first mile averaged",
  "developer or administrator actions on average before the recorded first-success boundary",
  "224 selected documented routes",
  "2,240",
  "median actions",
  "One record covers one selected route",
  "949",
  "1,021",
  "I found only",
  "explicitly named first success",
  "showed a terminal result without naming the milestone",
  "made any time-to-first-success claim",
  "56",
  "I found a median of",
  ...
  "324",
  "diagnosis-eligible",
  "A stopping point opens a hypothesis space",
  "Here are a few worth testing",
  "Work email required",
...
const forbiddenPatterns = [
  ...
  ["stale Atlas route count", /205(?:-route| selected documented routes| routes)/i],
  ["stale action average", /12\.5 actions|2,569 developer or administrator actions/i],
  ["vague Atlas relation label", /ATLAS RELATION/i],
