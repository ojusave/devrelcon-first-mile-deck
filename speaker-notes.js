...
For each platform, I selected one developer goal and traced one official documented route toward its first usable result. Across the Atlas dataset, the 2,359 documented steps include steps from both the selected primary routes and candidate routes, grounded in 949 official sources.
...
Once I had the routes, I looked at a basic question: does the documentation clearly tell the developer what first success is?`,
    ...
    evidenceBoundary: "The 224 records are source-grounded route records, but they are not user sessions, complete company journeys, product rankings, or verified shortest paths. The 2,359-step total includes primary and candidate routes. The current audit manifest marks all 224 selected records as needing human judgment.",
    sources: "Developer Journey Atlas live manifest generated July 22, 2026: https://developer-journey-atlas.onrender.com/data/index.json\n224 platforms, 2,359 documented steps across primary and candidate routes, and 949 official sources\nDeveloper Journey Atlas commit 065e4fa5b2d2ab38fd9fe965f5a6d7a1d1362edf",
  },
  14: {
